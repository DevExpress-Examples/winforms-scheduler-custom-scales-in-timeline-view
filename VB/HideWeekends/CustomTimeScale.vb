...
Namespace TimelineTimeScales
    ...
    Public Class TimeScaleWorkWeekDay
        ...
        Private Shared ReadOnly EndTime As TimeSpan = TimeSpan.FromHours(21 - 1)
        ...
        Protected Function GetNextDayOffset(ByVal dayOfWeek As DayOfWeek) As Integer
            If dayOfWeek = DayOfWeek.Friday Then Return 3
            If dayOfWeek = DayOfWeek.Saturday Then Return 2
            Return 1
        End Function
    End Class
    ...
    Public Class TimeScaleLessThanDay
        ...
        Public Overrides Function Floor(ByVal [date] As Date) As Date
            ...
            If [date].TimeOfDay < StartTime Then Return RoundToHour([date].AddDays(GetPreviousDayOffset([date].DayOfWeek)), EndTime)
        ...
        Protected Function GetPreviousDayOffset1(ByVal dayOfWeek As DayOfWeek) As Integer
            If dayOfWeek = DayOfWeek.Monday Then Return -3
            If dayOfWeek = DayOfWeek.Sunday Then Return -2
            If dayOfWeek = DayOfWeek.Saturday Then Return -1
            Return 0
        End Function
